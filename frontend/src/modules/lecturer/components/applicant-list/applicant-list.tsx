...
const ApplicantItem = React.memo<{
  ...
  if (application.rank !== undefined) {
    console.log(`🔍 Crown debug for ${application.fullName}:`, {
      ...
      shouldShowCrown: application.rank !== undefined && application.rank !== null
    });
  }
  ...
  const itemContent = (
    ...
    >
      ...
      <div className={styles.applicantInfo}>
        ...
        <div className={styles.applicantDetails}>
          ...
          <div className={styles.roleInfo}>
            ...
            {extendedApp.role?.roleName === "tutor" ? "Tutor" : 
             extendedApp.role?.roleName === "lab_assistant" ? "Lab Assistant" : 
             "Application"}
          </div>
      ...
      {application.rank !== undefined && application.rank !== null && application.rank > 0 && (
        <div
