import {
  ...
  getLecturerCourses,
} from '@/modules/lecturer/utils/lecturerUtils'; // Updated import path
...
describe('Lecturer Utilities', () => {
  ...
  test('getLecturersBySpecialization returns correct lecturers', () => {
    const aiLecturers = getLecturersBySpecialization('artificial intelligence');
  ...
  test('saveLecturerSelection saves a new selection', () => {
    const selection = saveLecturerSelection('lecturer1', 'tutor1', 'COMP1234');
  ...
  test('saveLecturerSelection updates an existing selection', () => {
    // First selection
    saveLecturerSelection('lecturer1', 'tutor1', 'COMP1234', 'Initial comment');
