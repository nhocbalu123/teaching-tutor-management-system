 ...
 * - Shows a crown icon for applicants added to ranking
            ...
            >
              ...
              {application.selected && (
                <div className="applicant-selected">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="applicant-selected-icon"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              {/* Visual indicator for applicants added to ranking */}
              {application.rank !== undefined && (
                <div
                  className="applicant-ranked"
