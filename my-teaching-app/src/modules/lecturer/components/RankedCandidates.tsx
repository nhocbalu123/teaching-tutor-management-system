...
const RankedCandidates: React.FC<RankedCandidatesProps> = ({
        ...
        return (
            <div className="empty-rankings">
                ...
                <p className="empty-rankings-help">
                    To rank candidates, select an applicant and click &quot;Add
                    to Ranking&quot;
                </p>
            </div>
        );
    ...
    return (
        <motion.div
            className="rankings-list-container"
                        ...
                        <div className="ranked-actions">
                            {index > 0 && (
                                <button
                                    ...
                                    className="rank-btn move-up-btn"
                                    title="Move up"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            {index < sortedApplications.length - 1 && (
                                <button
                                    ...
                                    className="rank-btn move-down-btn"
                                    title="Move down"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
