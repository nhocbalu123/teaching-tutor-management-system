    ...
    if (applications.length === 0) {
        return (
            <div className="empty-stats">
                ...
                <h3 className="empty-stats-title">
                        ...
                        {applicantStats.mostChosen ? (
                            <div className="top-applicant">
                                ...
                                <span className="info-count">
                                    ({applicantStats.mostChosen.count}{" "}
                                    selections)
                                </span>
                            </div>
                        ) : (
                        ...
                        <div className="insight-content">
                            ...
                            <p>
                                {availabilityData.length > 0
                                    ? `${
                                          availabilityData[0].value >
                                          availabilityData[1].value
                                              ? "Full-time"
                                              : "Part-time"
