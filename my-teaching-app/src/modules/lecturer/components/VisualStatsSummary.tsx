...
const VisualStatsSummary: React.FC<VisualStatsSummaryProps> = ({
        ...
        return (
            <div className="empty-summary">
                ...
                <p className="empty-summary-text">
                    Statistics will be displayed when applications are
                    submitted.
                </p>
            </div>
        );
    ...
    return (
        <motion.div
            className="visual-stats-summary"
        ...
        >
            ...
            <motion.div
                className="not-selected-container"
            ...
            >
                ...
                <div className="not-selected-visual">
                    ...
                    <span className="not-selected-count">
                        {notSelectedCount}
                    </span>
                </div>
                <p className="not-selected-text">
                    {notSelectedCount} out of {applications.length} applicants
                    pending selection
                </p>
            </motion.div>
                ...
                >
                    ...
                    <div className="popular-course-content">
                        ...
                        <div className="course-details">
                            ...
                            <p className="course-applications">
