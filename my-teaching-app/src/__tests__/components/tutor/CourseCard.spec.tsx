...
describe("CourseCard Component", () => {
    ...
    test("renders course information correctly", () => {
        render(<CourseCard course={mockCourse} openApplyModal={openApplyModalMock} />);
    ...
    test("renders Applied status when already applied", () => {
        render(<CourseCard course={mockCourse} openApplyModal={openApplyModalMock} hasApplied={true} />);
